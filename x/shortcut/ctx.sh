#!/usr/bin/env sh
## ctx.sh
# Sourcable script for `ctx()` function.

# Modified cdl.sh, set to change additional variables beyond $H and
# $PWD. I.e., load (and set with "-s") a shell "context".

# TODO: implement
# TODO: add 'ctx' to function-script list in sourced/shortcuts
